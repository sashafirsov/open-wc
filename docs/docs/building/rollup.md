...
We recommend the open-wc [project generator](https://open-wc.org/init/) for automated __Application__ project setup, for new projects or to upgrade existing projects.
